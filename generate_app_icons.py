...
def generate_ios_icons():
    # Source image
    source_path = "assets/images/logonew.JPG"
...
def update_pubspec_assets():
    ...
    try:
        ...
        if 'assets/images/logonew.JPG' not in content:
            ...
            print("✓ Ajouté logonew.JPG aux assets du pubspec.yaml")
        else:
            print("✓ logonew.JPG est déjà dans les assets")
...
def main():
    ...
    if not os.path.exists(source_path):
        ...
        print("Assurez-vous que logonew.JPG est dans le dossier assets/images/")
        return
