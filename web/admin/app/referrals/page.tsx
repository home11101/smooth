...
export default function ReferralsPage() {
  ...
  function handleLotterySearchChange(e: React.ChangeEvent<HTMLInputElement>) {
    setLotteryTab((prev) => ({ ...prev, search: e.target.value, page: 0 }));
  }
  ...
  function handleLotteryChangePage(event: unknown, newPage: number) {
    setLotteryTab((prev) => ({ ...prev, page: newPage }));
  }

  function handleLotteryChangeRowsPerPage(event: React.ChangeEvent<HTMLInputElement>) {
    setLotteryTab((prev) => ({ ...prev, rowsPerPage: +event.target.value, page: 0 }));
  }
          ...
          <TableContainer>
            <Table size="small">
              ...
              <TableBody>
                            ...
                            <Table size="small">
                              ...
                              <TableBody>
                                ...
                                {(r.filleulsDetails?.length === 0) && (
                                  <TableRow>
                                    <TableCell colSpan={3} align="center">Aucun filleul</TableCell>
                                  </TableRow>
                                )}
                              </TableBody>
                            </Table>
                ...
                {paginated.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={8} align="center">Aucun parrainage trouvé</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
          ...
          {lotteryStatsTab === 0 && (
            <Box>
              <Box sx={{ display: 'flex', gap: 2, mb: 2, alignItems: 'center' }}>
                ...
                <Button variant="outlined" onClick={() => setLotteryGrouped(g => !g)}>
